/**
 * VleisKraft™ PayFast Subscription Service
...
export const PLANS: SubscriptionPlan[] = [
  {
    ...
    trial_days: 0,
    max_branches: 1,
    features_en: ['Browse butchery catalogue', 'VleisAI™ (5 queries/month)', 'View promotions', 'Basic profile'],
    features_af: ['Blaai deur slaggery-katalogus', 'VleisKI™ (5 navrae/maand)', 'Sien promosies', 'Basiese profiel'],
  },
  {
    id: 'starter_monthly',
    name_en: 'Starter',
  ...
  },
  {
    ...
    trial_days: 0,
    max_branches: 1,
    features_en: ['All Starter features', 'Full analytics', 'Stockvel management', 'WooCommerce sync', 'Full demand intelligence', 'Meal planner', 'VleisAI™ unlimited'],
    features_af: ['Alle Beginner-funksies', 'Volledige analitika', 'Stockvel-bestuur', 'WooCommerce-integrasie', 'Volledige aanvraagintelligensie', 'Maaltydplanner', 'VleisKI™ onbeperk'],
  },
  {
    id: 'business_monthly',
    name_en: 'Business',
...
export function buildPaymentUrl(
  ...
  const params: Record<string, string> = {
    ...
    item_name:        `VleisKraft™ ${plan.name_en} — R${plan.amount.toLocaleString('en-ZA')}/maand`,
    subscription_type: '1',
